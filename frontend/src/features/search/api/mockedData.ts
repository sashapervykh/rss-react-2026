export const MOCKED_DATA = [
  ...
  {
    id: 1599009,
    title: 'Harry Potter: Fireplace',
    description:
      'The Wizarding World welcomes you into the common room of all four Hogwarts houses -- cozy up around a crackling fire and say hi to some familiar friends.',
  },
  {
    id: 1073217,
    title: 'Dan Potter',
